classdef LinearClassifier < handle
  ...
  methods
    ...
    function calc_boundary_grad(a)
      ...
      a.boundary_grad = a.threshold(-scaled_weights(1) ./ scaled_weights(2));
        ...
        if (mode)
          ...
          switch (mode)
            case 'b'
              ...
              %a.struct = svmtrain(inputs, outputs, 'AutoScale', true, 'BoxConstraint', 50, 'Method', 'SMO','showplot',true);
              a.struct = svmtrain(inputs, outputs, 'AutoScale', true, 'BoxConstraint', 50, 'Method', 'SMO');
              w = (a.struct.Alpha' * a.struct.SupportVectors);
              a.set_weights(w, a.struct.Bias, a.struct.SupportVectorIndices);
            case 'l'
              %LibSVM solution
            ...
            case 'o'
              ...
              optimized vector of weights - [w1 w2 bias] - and l containscha
